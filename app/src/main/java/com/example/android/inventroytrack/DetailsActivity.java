...
public class DetailsActivity extends AppCompatActivity {
    ...
    private static final String LOG_TAB=DetailsActivity.class.getCanonicalName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        priceEdit=(EditText)findViewById(R.id.product_name_edit);
        ...
        increaseQuantity=(ImageButton)findViewById(R.id.increase_quanity);
        ...
        if(currentItemId==0){
            ...
            addVauleToEditItem(currentItemId);
        }
    ...
    private void subtractOneToQuantity(){
        ...
        String perviousValuesString = quantityEdit.getText().toString();
        int perviousValues;
        if(perviousValuesString.isEmpty()){
            return;
        }else if (perviousValuesString.equals("0")){
            return;
        }else {
            perviousValues=Integer.parseInt(perviousValuesString);
            quantityEdit.setText(String.valueOf(perviousValues-1));
    ...
    public boolean onPrepareOptionsMenu(Menu menu){
        ...
        if (currentItemId==0){
            ...
            MenuItem deleteAllItemMenuItem = menu.findItem(R.id.action_delete_all_data);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
         switch (item.getItemId())
         {
             ...
             case R.id.action_delete_item:
                                    showDeleteConfimationDialog(currentItemId);
                                    return true;
             case R.id.action_delete_all_data:
                                    showDeleteConfimationDialog(0);
                                    return true;
         }
...
private void addVauleToEditItem(long itemId)
{
...
private void showOrderConfirmationDialog(){
    ...
    builder.setNegativeButton(R.string.email, new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int id) {
            ...
            intent.setData(Uri.parse("mailto:"+supplierEmailEdit.getText().toString().trim()));
            intent.putExtra(android.content.Intent.EXTRA_TEXT,"Recurrent new order");

            String bodyMessage ="Please send us as soon as possible more"+nameEdit.getText().toString().trim()+"!!!";
 ...
 private int deleteAllRowsFromTable(){
    ...
    private int deleteOneItemFromTable(long itemId){
        ...
        int rowsDeleted = database.delete(StockContract.StockEntry.TABLE_NAME,selection,selectionArgs);
        return rowsDeleted;
    }

    private void showDeleteConfimationDialog(final long item){
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
